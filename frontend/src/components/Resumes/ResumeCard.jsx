  ...
  const cardFooter = (
    <div className={styles.resumeActions}>
      <Link
        ...
        className={clsx(styles.actionLink, styles.actionLinkView, "hover:text-blue-500 transition-colors duration-200")}
      >
        View
      </Link>
      <Link
        to={`/resumes/${resume.id}/edit`}
        className={clsx(styles.actionLink, styles.actionLinkEdit, "hover:text-gray-500 transition-colors duration-200")}
      >
        Edit
      </Link>
      <Link
        to={`/resumes/${resume.id}/customize`}
        className={clsx(styles.actionLink, styles.actionLinkCustomize, "hover:text-green-500 transition-colors duration-200")}
      >
        Customize
      </Link>
      <button
        onClick={() => onDeleteClick(resume)}
        className={clsx(styles.actionLink, styles.actionLinkDelete, "hover:text-red-500 transition-colors duration-200")}
      >
        Delete
      </button>
    </div>
