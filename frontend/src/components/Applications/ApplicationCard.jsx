    ...
    <div className={styles.applicationRight}>
      <div className={styles.actionButtons}>
        <button
          ...
          className={clsx(styles.actionButton, styles.actionButtonDownload, "hover:text-green-600")}
        ...
        {application.cover_letter_version_id && (
          <button
            ...
            className={clsx(styles.actionButton, styles.actionButtonDownloadCL, "hover:text-green-600")}
        ...
        <button
          ...
          className={clsx(styles.actionButton, styles.actionButtonView, "hover:text-gray-600")}
          title="View details"
        >
        ...
        <button
          ...
          className={clsx(styles.actionButton, styles.actionButtonEdit, "hover:text-blue-600")}
        ...
        <button
          ...
          className={clsx(styles.actionButton, styles.actionButtonDelete, "hover:text-red-600 disabled:opacity-50")}
          title="Delete application"
        >
          {operationLoading ? <LoadingSpinner size="sm" /> : <TrashIcon className="h-4 w-4" />}
        </button>
      </div>
    </div>
  );
      ...
      <div className={styles.applicationCenter}>
        <div className={styles.statusControl}>
          ...
          <StatusSelect
            ...
            disabled={operationLoading}
            className={clsx(styles.statusSelectInline, "focus:ring-blue-500 focus:border-blue-500")}
          />
        </div>
      </div>
    </BaseCard>
