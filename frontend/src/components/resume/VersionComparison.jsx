...
export default function VersionComparison({ versions, currentContent, onVersionSelect, onClose }) {
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="border border-blue-200 rounded-lg p-3 bg-blue-50">
            <div className="flex items-center justify-between">
              <div>
                <div className="font-medium text-blue-900">Current Version</div>
        ...
        <div className="flex-1 border-t border-gray-200 bg-gray-50">
          <div className="p-4">
            <h4 className="font-medium text-gray-900 mb-3">
              Changes from Version {versions.findIndex(v => v.id === selectedVersion.id) + 1} to Current
            </h4>
