...
import styles from './AIProgressIndicator.module.css';
    ...
    switch (stage) {
      ...
      case 'customizing':
        return {
          ...
          defaultMessage: 'Tailoring your VersionComparison to match the job description'
        };
      case 'generating':
        return {
          icon: (
      ...
      default:
        return {
          ...
          title: 'Processing',
          defaultMessage: 'Working on your VersionComparison'
        };
    }
  };
...
function getTip(stage) {
  const tips = {
    analyzing: "AI is scanning the job description to identify key skills, requirements, and keywords that should be emphasized in your VersionComparison.",
    customizing: "Your VersionComparison content is being intelligently restructured to better align with the job requirements while maintaining your unique experience.",
    ...
    finalizing: "Final optimizations are being applied to ensure your VersionComparison passes ATS systems and catches recruiter attention."
  };

  return tips[stage] || "AI is working to create the best possible version of your VersionComparison for this specific job opportunity.";
}
